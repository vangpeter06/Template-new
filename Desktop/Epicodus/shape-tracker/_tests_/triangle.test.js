...
describe('Triangle', () => {
  ...
  test('should correctly determine whether three lengths makes a scalene triangle', () => {
  ...
  test("should correctly determine whether three lengths makes a equilateral triangle", () => {
